...
class ConsignmentAdapter(private val mContext: Context,
                         private val mArticle:List<ArticleModel>):RecyclerView.Adapter<ConsignmentAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.consignment_item_layout, parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            pref.apply()
            Navigation.findNavController(holder.itemView).navigate(R.id.action_navigation_notifications_to_trackingFragment)
        }
